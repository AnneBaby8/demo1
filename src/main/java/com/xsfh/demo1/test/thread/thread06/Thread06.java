package com.xsfh.demo1.test.thread.thread06;
...
public class Thread06 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        resultList.add(executor.submit(new Stats("任务E", 1000)));       //遍历任务的结果
    ...
    static class Stats implements Callable<String> {
        ...
        public String call() {
            try {
                System.out.println(statsName + " do stats begin at " + startTime);                //模拟任务执行时间
